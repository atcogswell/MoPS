...
points(x = -63.317, y = 44.267, cex = 3, lwd = 2.5, col = "gray35")
points(x = -63.317, y = 44.267, cex = 2, lwd = 2.5, col = "gray35")
...
polygon(x = c(-66.5, -59.5, -59.5, -66.5, -66.5),
