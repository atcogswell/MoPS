---
title: "Summary of Employment Objectives and Deliverables"
author: "Scott McCain"
date: "May 26, 2017"
output:
...
-	Wrote a flexible series of R scripts to perform a series of objectives: file conversion, file transfer, and plotting. This framework (detailed below) can be used for any other fixed station websites.
-	Updated the Bedford Basin Monitoring Program, by completing plots from 1999-2009, and ODFs from 1999-2009.
-	Converted all current ODFs to CSVs onto the website as well, and created a continually updating aggregated CSV with consistent formatting.
...
-	Met with stakeholders to establish goals and use-cases for website
    +	Catherine Johnson, Emmanuel Devred, Dave Brickman, Andrew Cogswell (BIO)
...
-	Write detailed site description and sampling overview m
