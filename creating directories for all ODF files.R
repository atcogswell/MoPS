...
library(stringr)
#create 
# years_odf_missing <- c(1999:2017) %>% as.character()

#Loop for creating the folder names
# for(year_missing in 1:length(years_odf_missing)){
#   # year_missing <- "1999"
#   dir_missing <- paste("R:\\Shared\\Cogswell\\_BIOWeb\\BBMP\\CSV", "\\", years_odf_missing[year_missing], sep = "")
#   dir.create(dir_missing)
# }
